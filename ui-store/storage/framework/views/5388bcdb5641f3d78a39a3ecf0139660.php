 <footer>
    <div class="container mt-3">
      <div class="row">
        <div class="col-sm-12 col-md-4 mb-3">
          <h3 class="fw-bold text-capitalize"><?php echo e($datas['nama_toko']); ?></h3>
          ...
          <div class="kontakToko">
            ...
            <a href="mailto:<?php echo e($datas['Email_toko']); ?>"><i class="fa-regular fa-envelope"></i></a>
            <a href="tel:<?php echo e($datas['Telpon_toko']); ?>"><i class="fa-brands fa-whatsapp"></i></a>
          </div>
        </div>
    ...
    <div class="CP-footer d-flex justify-content-center mt-3">
      <h5>Copyright © 2023 All rights reserved by <?php echo e($datas['nama_toko']); ?></h5>
    </div>
  </footer>
  <!-- end footer --><?php /**PATH C:\xampp\htdocs\Tubes-EAI\ui-store\resources\views/parts/footer.blade.php ENDPATH**/ ?>